...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    web_search: Schema.optional(Action),
    memory: Schema.optional(Action),
    history: Schema.optional(Action),
    workflow: Schema.optional(Action),
    screenshot: Schema.optional(Action),
